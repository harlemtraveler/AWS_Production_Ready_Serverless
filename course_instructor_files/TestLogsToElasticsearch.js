...
exports.handler = function(input, context) {
    ...
    zlib.gunzip(zippedInput, function(error, buffer) {
        ...
        // Define an Obj to hold returned customMetrics & usageMetrics
        ...
        // NOTE: Define a var that calls custom metric parsing logic, assigning itself the returned data
        // var 
        ...
        // if (!allMetricBulkData) {
        //     console.log('[!] No Custom or Usage metrics found');
        //     return;
        // }
...
// MOST-RECENT-CHANGES-12-28-2019
...
//****//
    ...
    // First, parse CW invocation event JSON Obj to obtain top-level Obj properties
...
//****//
        ...
        // DOES THE PARAMS NEED TO BE "logEvents.logEvent"???
        // >>>parseAll
        var parseAll = function (logGroup, logStream, logEvents) {
            ...
            // return logs, customMetrics, usageMetrics;
            // return customMetricsBody, usageMetricsBody;
        };
...
//****//
        ...
        // We should attempt to create a similar workflow for the two additional Objs we wish to pass up the exec chain.
        bulkRequestBody += [ 
    ...
    // - The original function just returned an Obj called "bulkRequestBody" (*this variable will contain a log Obj compressed into a single String)
    // 
